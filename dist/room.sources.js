...
export function roomData(roomObject) {
    ...
    locations.forEach((location) => {
        const openSlots = _.filter(roomObject.lookForAtArea(LOOK_TERRAIN, location.pos.y - 1, location.pos.x - 1, location.pos.y + 1, location.pos.x + 1, true), (result) => result.terrain == 'plain').length;
